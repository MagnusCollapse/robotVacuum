...
public class MOMGame extends JFrame implements Runnable {
  ...
  public MOMGame() throws IOException {
    ...
    map = new MyMap(MOMGame.getWindowBounds().getWidth(),MOMGame.getWindowBounds().getWidth());
  ...
  private class Root extends JComponent {
    ...
    public Root(Consumer<Graphics2D> draw) {
      this.draw = draw;
      this.setPreferredSize(MOMGame.getWindowBounds().getSize());
    }
